...
No registration of the funding carry as a lane follows from WO-167's GO or WO-170's corrected
pass. The registry's WO-166 paragraph provides for a future pre-observation amendment with a
fresh out-of-sample window; that amendment is not the one added here, is not drafted, and needs
a VPS.
