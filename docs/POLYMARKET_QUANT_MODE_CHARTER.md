...
**2026-07-16 - WO-99 implemented by Codex.** The resolved-market trainer now
has explicit point-in-time provenance: append-only resolution states,
append-only executable bid/ask observations from the live websocket/archive,
separate feature and label files, and a whole-market purged chronological
