...
ENRICHED = Path("outputs/polymarket_model_governance/worldcup_historical_clob_enriched_condition_registry_closed_only.csv")
LABELS = Path("outputs/polymarket_training/worldcup_historical_clob_moneyline_labels_closed_only.csv")
PRICE_HISTORY = Path("outputs/polymarket_training/worldcup_historical_clob_moneyline_price_history_closed_only.csv")
SUMMARY = Path("outputs/polymarket_model_governance/worldcup_historical_clob_registry_backfill_closed_only_summary.json")
