...
HISTORY = Path("outputs/polymarket_training/worldcup_historical_clob_moneyline_price_history.csv")
LABELS = Path("outputs/polymarket_training/worldcup_historical_clob_moneyline_labels.csv")

OUT_TOKEN = Path("outputs/polymarket_training/worldcup_historical_clob_token_validation.csv")
OUT_MONEYLINE = Path("outputs/polymarket_training/worldcup_historical_clob_moneyline_validation.csv")
SUMMARY = Path("outputs/polymarket_model_governance/worldcup_historical_clob_validation_summary.json")
