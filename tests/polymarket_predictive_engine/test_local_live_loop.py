...
def test_websocket_asset_discovery_excludes_frozen_governance_targets(tmp_path, monkeypatch):
    ...
    _write_csv(
        ...
        [
            {
                "token_id": "proof-target-token",
                "market_slug": "bitcoin-up-or-down-proof-bucket",
    ...
    _write_csv(
        ...
        [
            {"token_id": "shadow-token", "market_slug": "generic-shadow-market"},
        ],
    )
    _write_csv(
        cfg.output_root / "polymarket" / "market_snapshot.csv",
...
def test_websocket_asset_discovery_keeps_open_positions_ahead_of_governance_targets(tmp_path, monkeypatch):
    ...
    _write_csv(
        ...
        [
            {
                "token_id": "proof-target-token",
                "market_slug": "solana-up-or-down-proof-bucket",
                "websocket_target_reason": "paper_confirmation_blocker",
            },
        ],
    )
...
def test_websocket_asset_discovery_skips_closed_governance_targets_from_unix_slug(tmp_path, monkeypatch):
    ...
    _write_csv(
        ...
        [
            {
                "token_id": "closed-unix-proof-target",
                "market_slug": "btc-updown-15m-1609459200",
                "websocket_target_reason": "paper_confirmation_blocker",
            },
            {
                "token_id": "future-unix-proof-target",
...
def test_websocket_asset_discovery_skips_closed_governance_targets_from_et_slug(tmp_path, monkeypatch):
    ...
    _write_csv(
        ...
        [
            {
                "token_id": "closed-et-proof-target",
                "market_slug": "bitcoin-up-or-down-january-1-2000-12pm-et",
                "websocket_target_reason": "paper_confirmation_blocker",
            },
            {
                "token_id": "future-et-proof-target",
                "market_slug": "bitcoin-up-or-down-january-1-2100-12pm-et",
                "websocket_target_reason": "paper_confirmation_blocker",
            },
        ],
    )
